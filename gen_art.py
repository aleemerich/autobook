...
def call_claude(prompt, max_tokens=1500):
    ...
    system = (
        "You are an art director and visual style designer. "
        "You define visual style identities based on literary themes and voice."
    )
    return call_llm(prompt=prompt, system_prompt=system, temperature=0.3, is_judge=False)
