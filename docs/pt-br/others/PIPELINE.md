...
> Referencia historica: este arquivo preserva um desenho antigo de pipeline e
> pode citar comandos, caminhos e premissas obsoletas. Para o contrato
> operacional atual, comece em `../INDICE.md`.
