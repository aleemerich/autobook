...
def build_beat_draft_prompt(
    ...
    return (
        ...
        f"- Não invente fatos médicos, cognitivos, familiares, legais, tecnológicos, mágicos, religiosos, conspiratórios ou relacionais que não estejam no outline, world, characters ou canon.\n"
        f"- Se faltar um detalhe factual, escreva a cena sem criar canon novo.\n"
