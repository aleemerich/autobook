...
def call_claude(prompt, max_tokens=3000):
    """Call the unified LLM via llm.py and return response text."""
    from llm import call_llm
    system = (
        "You are a professional art director and visual designer. "
        "You generate creative, diverse, and extremely specific image generation prompts."
    )
    return call_llm(prompt=prompt, system_prompt=system, temperature=0.9, is_judge=False)
